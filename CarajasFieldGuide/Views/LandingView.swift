        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: -4) {
                    Text("banner.snakes_of", comment: "First line of the landing title block")
                ...
                VStack(alignment: .trailing, spacing: 12) {
                    ...
                    HStack(alignment: .center, spacing: 0) {
                        ...
                        hubButton(label: LocaleManager.shared.localizedString("landing.privacy_policy", defaultValue: "Privacy policy")) { showPrivacy = true }
                        Spacer()
                        hubButton(label: LocaleManager.shared.localizedString("landing.about", defaultValue: "About")) { showAbout = true }
                        Spacer()
