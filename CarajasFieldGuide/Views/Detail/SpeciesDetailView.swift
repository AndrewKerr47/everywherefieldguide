            ...
            if let venom = species.venomStatus {
                FactRowView(background: venom.rowBackground) {
                    HStack(spacing: 12) {
                        ...
                        Text("detail.venom_label", comment: "Label for the venom fact row")
                            .font(.factLabel)
                            .textCase(.uppercase)
                            .tracking(1.0)
            ...
            if let size = species.sizeDisplay {
                FactRowView(background: .clear) {
                    HStack(spacing: 12) {
                        ...
                        Text("detail.size_label", comment: "Label for the size fact row")
                            .font(.factLabel)
                            .textCase(.uppercase)
                            .tracking(1.0)
                            .foregroundColor(.onSurface)
                ...
                FactRowView(background: .clear) {
                    HStack(spacing: 12) {
                        Image("icon_habitat")
                            ...
                            .frame(width: 28, height: 28)
                            .foregroundColor(.appPrimary)
                        Text("detail.habitat_label", comment: "Label for the habitat fact row")
                            .font(.factLabel)
                            .textCase(.uppercase)
                            .tracking(1.0)
                            .foregroundColor(.onSurface)
            ...
            if let iucn = species.iucnStatus {
                FactRowView(background: .clear) {
                    HStack(spacing: 12) {
                        ...
                        Text("detail.iucn_label", comment: "Label for the IUCN status fact row")
                            .font(.factLabel)
                            .textCase(.uppercase)
                            .tracking(1.0)
                            .foregroundColor(.onSurface)
...
struct SurveyPresenceView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: AppSpacing.labelMargin) {
            Text("detail.survey_presence",
                 comment: "Section heading for survey presence pills")
                .sectionLabelStyle()
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: AppSpacing.labelMargin) {
            ...
            HStack(alignment: .lastTextBaseline) {
                Text("detail.inat_visibility",
                     comment: "Section heading for iNaturalist visibility bar")
                    .sectionLabelStyle()
                Spacer()
                if let count = species.inatObservations {
                    Text(String(format: String(localized: "detail.inat_observations",
...
struct ImageCreditView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("detail.image_credit",
                 comment: "Section label above the image credit line")
                .sectionLabelStyle()
