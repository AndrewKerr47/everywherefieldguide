                    ...
                    if filteredSpecies.isEmpty {
                        ...
                        ForEach(filteredSpecies) { species in
                            NavigationLink(
                                ...
                                SpeciesRowView(species: species, showPortugueseNames: showPortugueseNames, isSeen: seenStore.isSeen(species.scientificName))
                            }
                            .buttonStyle(.plain)
                        }
                    }
            ...
            ZStack(alignment: .bottomLeading) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    HStack(alignment: .bottom) {
                        ...
                        // Always toggles Brazilian Portuguese names regardless
                        // of the app language setting.
                        Button {
